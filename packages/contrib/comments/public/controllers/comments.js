...
angular.module('mean.comments').controller('CommentsController', ['$scope', '$http', 'Global', '$stateParams', 'Comments', 'FetchComments', 'mentionUser', 'MeanSocket', 'utils',
  function($scope, $http, Global, $stateParams, Comments, FetchComments, mentionUser, MeanSocket, utils) {
